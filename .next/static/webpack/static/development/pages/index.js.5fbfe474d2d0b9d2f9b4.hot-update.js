      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            _context.next = 12;
            return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(setEventsNo(data.length));

          case 12:
            console.log('data.lenght: ', data.length);
            console.log('eventsNo', eventsNo);
          ...
          case 17:
            ...
            console.log(Math.floor(eventsNo / pageSize) + 1);
...
//# sourceMappingURL=index.js.5fbfe474d2d0b9d2f9b4.hot-update.js.map